...
interface ExclusiveLikeData {
  ExclusiveContentLikedInterval: ContentData[];
}
...
const ExclusiveLikeChart = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    const fetchAll = async () => {
      ...
      try {
        const { data } = await contentClient.query<ExclusiveLikeData>({
...
export default ExclusiveLikeChart;
